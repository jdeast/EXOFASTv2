pro fithat3_threads, debug=debug, verbose=verbose, maxsteps=maxsteps, nthin=nthin, outpath=outpath
...
for j=0L, 2 do begin
   for i=1L, 8 do begin
      ...
      exofastv2, nplanets=1, tranpath=path+'n20070428.Sloani.KepCam.dat', $
                 ...
                 prefix=outpath+'HAT-3b.Threaded.MIST.' + string(j,i,format='(i03,".",i03)') + '.', mistsedfile='hat3.sed',$
                 maxsteps=maxsteps, $
