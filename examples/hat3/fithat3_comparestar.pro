...
exofastv2, nplanets=1, tranpath=path+'n20070428.Sloani.KepCam.dat', rvpath=path+'HAT-3b.HIRES.rv',priorfile=path+'hat3.priors', prefix=path+'fitresults' + path_sep()+'HAT-3b.SED+MIST+Transit.', maxsteps=maxsteps, nthin=nthin, circular=[1], fitrv=[1],fittran=[1], debug=debug, verbose=verbose, fluxfile=path+'hat3.sed', dontstop=dontstop
...
exofastv2, nplanets=0, priorfile=path+'hat3.priors', prefix=path+'fitresults' + path_sep()+'HAT-3b.SED+MIST.', maxsteps=maxsteps, nthin=nthin, debug=debug, verbose=verbose, fluxfile=path+'hat3.sed', dontstop=dontstop
