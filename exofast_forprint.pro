...
else openw, lun, textout, /get_lun
...
for i=0, n_elements(v1)-1 do begin
   ...
   if n_elements(v18) ne 0 then begin
      printf, lun, v1[i],v2[i],v3[i],v4[i],v5[i],v6[i],v7[i],v8[i],v9[i],$
      ...
      printf, lun, v1[i],v2[i],v3[i],v4[i],v5[i],v6[i],v7[i],v8[i],v9[i], format=format
   endif else if n_elements(v8) ne 0 then begin
      printf, lun, v1[i],v2[i],v3[i],v4[i],v5[i],v6[i],v7[i],v8[i], format=format
   endif else if n_elements(v7) ne 0 then begin
      printf, lun, v1[i],v2[i],v3[i],v4[i],v5[i],v6[i],v7[i], format=format
   endif else if n_elements(v6) ne 0 then begin
      printf, lun, v1[i],v2[i],v3[i],v4[i],v5[i],v6[i], format=format
   endif else if n_elements(v5) ne 0 then begin
      printf, lun, v1[i],v2[i],v3[i],v4[i],v5[i], format=format
   endif else if n_elements(v4) ne 0 then begin
      printf, lun, v1[i],v2[i],v3[i],v4[i], format=format
   endif else if n_elements(v3) ne 0 then begin
      printf, lun, v1[i],v2[i],v3[i], format=format
   endif else if n_elements(v2) ne 0 then begin
      printf, lun, v1[i],v2[i], format=format
   endif else if n_elements(v1) ne 0 then begin
      printf, lun, v1[i], format=format
   endif

endfor

if n_elements(textout) ne 0 then free_lun, lun
